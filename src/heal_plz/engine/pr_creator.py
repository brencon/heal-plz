...
class PRCreator:
    ...
    async def create_pr(
        ...
        for change in fix_result.changes:
            file_info = await self.github.get_file_info(
                owner, repo, change.path, ref=branch_name
            )
...
---
*This PR was automatically generated by [heal-plz](https://github.com/brencon/heal-plz) — the self-healing coding platform.*
"""
